		...
		{jstabs}
			{jstab title="User"}
				{form}
					{legend legend="User Information"}
						...
						<div class="control-group submit">
							<input type="submit" class="ink-button" name="prefs" value="{tr}Change preferences{/tr}" />
						</div>
					{/legend}
				{/form}
				...
				{form legend="Change your email address" secure=$gBitSystem->isFeatureActive("site_https_login_required")}
					...
					<div class="control-group submit">
						<input type="submit" class="ink-button" name="chgemail" value="{tr}Change email{/tr}" />
					</div>
				{/form}
				</div>
				...
				{form legend="Change your password" secure=$gBitSystem->isFeatureActive("site_https_login_required")}
					...
					<div class="control-group submit">
						<input type="submit" class="ink-button" name="chgpswd" value="{tr}Change Password{/tr}" />
					</div>
				{/form}
				</div>
				...
				{if $gBitSystem->isFeatureActive( 'feature_tasks' )}
					{form legend="User Tasks"}
						...
						<div class="control-group submit">
							<input type="submit" class="ink-button" name="tasksprefs" value="{tr}Change preferences{/tr}" />
						</div>
					{/form}
				{/if}
			{/jstab}
