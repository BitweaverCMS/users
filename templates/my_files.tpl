...
<table class="panel">
	...
	{foreach from=$userFiles item=userFile}
		<tr>
			...
			<td><a href="javascript:confirmDelete('{$userFile.filename}','{$smarty.const.USERS_PKG_URL}my_files.php?deleteAttachment={$userFile.attachment_id}')">{biticon ipackage="liberty" iname="delete" iexplain="Delete"}</a></td>
		</tr>
