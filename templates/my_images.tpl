...
<div class="admin userimages">
	...
	<div class="body">
		{form enctype="multipart/form-data" legend="Upload personal Portrait, Avatar and Logo"}
			...
			<div class="control-group column-group gutters">
				...
				{if $gQueryUser->mInfo.portrait_attachment_id}
					{forminput}
						...
						<input type="submit" class="ink-button" value="{tr}delete self portrait{/tr}" name="delete_portrait" id="delete_portrait"/>
					{/forminput}
				{/if}
			...
			<div class="control-group column-group gutters" id="avatarfilerow">
			...
			<div class="control-group column-group gutters">
				...
				{if $gQueryUser->mInfo.avatar_attachment_id}
					{forminput}
						...
						<input type="submit" class="ink-button" value="{tr}delete avatar{/tr}" name="delete_avatar" />
					{/forminput}
				{/if}
			...
			<div class="control-group column-group gutters">
				...
				{if $gQueryUser->mInfo.logo_attachment_id}
					{forminput}
						...
						<input type="submit" class="ink-button" value="{tr}delete logo{/tr}" id="delete_logo" name="delete_logo" />
					{/forminput}
				{/if}
			...
			<div class="control-group submit">
				<input type="submit" class="ink-button" name="store" value="{tr}Save Changes{/tr}" />
			</div>
		{/form}
	</div><!-- end .body -->
</div><!-- end .userimages -->
